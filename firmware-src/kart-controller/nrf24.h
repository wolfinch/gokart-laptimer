...
#define nrf24_CONFIG ((1<<EN_CRC)|(0<<CRCO))        // 16bit CRC
 ...
 *    - state:0 => Pin LOW     */
/* -------------------------------------------------------------------------- */
extern inline void nrf24_csn_digitalWrite(uint8_t state);
...
extern uint8_t getCRCLength(void);

extern uint8_t getDataRate( void );

extern uint8_t getPALevel(void);

extern void print_observe_tx(void);
